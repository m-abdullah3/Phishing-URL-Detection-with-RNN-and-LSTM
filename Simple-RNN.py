...
from tensorflow.keras.layers import SimpleRNN, Dense, Dropout, SpatialDropout1D # layers to be used to build the DL model
...
embeddingVectoreLen = 100  # Dimension of word embeddings
